...
export default function CreateProfilePage() {
  ...
  const handleSubmit = (event: FormEvent<HTMLFormElement>) => {
    ...
    if (!name.trim() || !username.trim() || interests.length === 0) {
      return;
    }
        ...
        {saved ? (
          <section className="animate-completion-in mt-8 rounded-[28px] border border-[var(--line)] bg-[var(--paper)] p-8 text-center shadow-[0_18px_50px_rgba(37,33,31,0.08)] sm:p-12">
            ...
            <p className="mx-auto mt-3 max-w-[520px] text-base leading-7 text-[var(--muted)]">
              Your profile information has been prepared. Once your account
              backend is connected, this information will be securely saved
              to your myFolks account.
            </p>

            <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
              <a
                href="/"
                className="rounded-full bg-[var(--ink)] px-6 py-3 text-sm font-bold text-[var(--paper)] shadow-[0_8px_20px_rgba(37,33,31,0.14)] transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_12px_26px_rgba(37,33,31,0.18)]"
              >
                Go to Discover
              </a>
            ...
            <section className="animate-card-in animation-delay-200 rounded-[28px] border border-[var(--line)] bg-[var(--paper)] p-6 shadow-[0_14px_40px_rgba(37,33,31,0.055)] sm:p-8">
              ...
              <div className="mt-7 grid gap-5 sm:grid-cols-2">
                <label className="block">
                  ...
                  <input
                    ...
                    maxLength={60}
                    required
                    className="w-full rounded-2xl border border-[var(--line)] bg-[var(--mist)] px-4 py-3.5 text-[var(--ink)] outline-none transition-all duration-300 placeholder:text-[var(--muted)] focus:border-[var(--ink)] focus:bg-[var(--paper)] focus:ring-4 focus:ring-[var(--lavender)]"
                  />
                </label>
                ...
                <label className="block">
                  ...
                  <div className="flex overflow-hidden rounded-2xl border border-[var(--line)] bg-[var(--mist)] transition-all duration-300 focus-within:border-[var(--ink)] focus-within:bg-[var(--paper)] focus-within:ring-4 focus-within:ring-[var(--lavender)]">
                    ...
                    <input
                      ...
                      maxLength={30}
                      required
                      className="min-w-0 flex-1 bg-transparent px-2 py-3.5 text-[var(--ink)] outline-none placeholder:text-[var(--muted)]"
                    />
                  </div>
              ...
              <label className="mt-5 block">
                ...
                <textarea
                  ...
                  maxLength={240}
                  rows={4}
                  className="w-full resize-none rounded-2xl border border-[var(--line)] bg-[var(--mist)] px-4 py-3.5 text-[var(--ink)] outline-none transition-all duration-300 placeholder:text-[var(--muted)] focus:border-[var(--ink)] focus:bg-[var(--paper)] focus:ring-4 focus:ring-[var(--lavender)]"
                />
                  ...
                  <div className="mt-3 space-y-2">
                    <label className="flex cursor-pointer items-start gap-3 rounded-2xl border border-[var(--line)] p-4 transition-all duration-300 hover:bg-[var(--mist)]">
                      <input
                        ...
                        onChange={(event) =>
                          setMessagePermission(event.target.value)
                        }
                        className="mt-1 accent-[var(--ink)]"
                      />
